...
const LayoutLanding = () => {
    ...
    // // ESTE USE EFFECT ES PARA AQUELLAS RUTAS QUE NO LLEVAN A OTRA PÁGINA, SI NO A UNA SECCIÓN DENTRO DEL HOME: SERVICIOS POR EJEMPLO
    // useEffect(() => {
    //     if (params.hash == '#servicesSection'){
    ...
    return (
        <>
            <header className="fixed top-[0px] w-full z-[100]">
                                                    ...
                                                    <li key={index} className="link-menu b-font-size-18">
                                                        {
                                                            item.path.includes('#')
                                                                ? (
                                                                    <a href={item.path} className={isLinkActive({isActive: true})}>{item.label}</a>
                                                                )
                                                                : (
                                                                    <NavLink to={item.path} className={isLinkActive}>{item.label}</NavLink>
                                                                )
